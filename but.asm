...
; *** input:
; *** ------
; *** y = screen (not petscii) code of button to check.
; ***
; *** output:
; *** -------
...
; ***
;
but_pre$ lda (key_row$),y ; set keyboard row to check (seems to be the way to do
         sta pia1porta$   ; this, just "overwrite" whole port a with row nr.
                          ; 0-9).

         lda pia1portb$ ; loads row's data.
         and (key_neg$),y ; checks, if button is pressed.
         rts
